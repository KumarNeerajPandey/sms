...
//  public static final String SQL_CHECK_ID_EXISTENCE = "SELECT STUDENT_ID FROM STUDENT WHERE STUDENT_ID = ?";
    ...
    public static final String SQL_GET_STUDENT_BY_ID = "SELECT STUDENT_ID, FIRST_NAME, MIDDLE_NAME, LAST_NAME, DOB, BLOODGROUP, GENDER, PHONE, EMAIL_ID, FATHER_NAME, FATHER_PHONE, IDENTITY_TYPE, IDENTITY_NUMBER, NATIONALITY, ADDRESS_LINE1, ADDRESS_LINE2, CITY, STATE, COUNTRY, POSTAL_CODE FROM STUDENT WHERE STUDENT_ID= ?";

    public static final String SQL_GET_ALL_STUDENT = "SELECT STUDENT_ID, FIRST_NAME, MIDDLE_NAME, LAST_NAME, DOB, BLOODGROUP, GENDER, PHONE, EMAIL_ID, FATHER_NAME, FATHER_PHONE, IDENTITY_TYPE, IDENTITY_NUMBER, NATIONALITY, ADDRESS_LINE1, ADDRESS_LINE2, CITY, STATE, COUNTRY, POSTAL_CODE FROM STUDENT";
